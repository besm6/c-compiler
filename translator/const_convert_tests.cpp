...
protected:
    ...
    Const make_const_char(int8_t v) { Const c = {CONST_CHAR, .value.char_val = v}; return c; }
    Const make_const_uchar(uint8_t v) { Const c = {CONST_UCHAR, .value.uchar_val = v}; return c; }
    Const make_const_int(int32_t v) { Const c = {CONST_INT, .value.int_val = v}; return c; }
    Const make_const_long(int64_t v) { Const c = {CONST_LONG, .value.long_val = v}; return c; }
    Const make_const_uint(uint32_t v) { Const c = {CONST_UINT, .value.uint_val = v}; return c; }
    Const make_const_ulong(uint64_t v) { Const c = {CONST_ULONG, .value.ulong_val = v}; return c; }
    Const make_const_double(double v) { Const c = {CONST_DOUBLE, .value.double_val = v}; return c; }
...
TEST_F(ConstConvertTest, ConvertToDouble) {
    ...
    TEST_DOUBLE_CONVERSION(max_ulong, TYPE_DOUBLE, CONST_DOUBLE, (double)UINT64_MAX); // Special case
