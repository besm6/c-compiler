...
// DISABLED: IEEE infinity semantics and libc copysign not on BESM-6
TEST_F(CodegenTest, DISABLED_Chapter19_WP_AllTypes_FoldInfinity)
{
    CompileAndRun(WrapMain(R"WP(
...
// DISABLED: IEEE signed-zero semantics and libc copysign not on BESM-6
TEST_F(CodegenTest, DISABLED_Chapter19_WP_AllTypes_FoldNegativeZero)
{
    CompileAndRun(WrapMain(R"WP(
