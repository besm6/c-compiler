...
{
    EXPECT_EQ("0\n", CompileAndRunBook("int main(void) { int a = 3; a = a + 5; }"));
}
...
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int a = 2; return a; }"));
}
...
{
    EXPECT_EQ("0\n", CompileAndRunBook("int main(void) { 2 + 2; return 0; }"));
}
...
{
    EXPECT_EQ("0\n", CompileAndRunBook("int main(void) { int a = 0 && a; return a; }"));
}
...
{
    EXPECT_EQ("24\n", CompileAndRunBook("int main(void) { int x = 3; return x << 3; }"));
}
...
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int to_and = 3; to_and &= 6; return to_and; }"));
}
...
{
    EXPECT_EQ("31\n", CompileAndRunBook("int main(void) { int to_or = 1; to_or |= 30; return to_or; }"));
}

// to_shiftl <<= 4;
TEST_F(CodegenTest, Chapter5_CompoundBitwiseShiftl)
{
    EXPECT_EQ("48\n", CompileAndRunBook("int main(void) { int to_shiftl = 3; to_shiftl <<= 4; return to_shiftl; }"));
}

// to_shiftr >>= 4;
TEST_F(CodegenTest, Chapter5_CompoundBitwiseShiftr)
{
    EXPECT_EQ("23910\n", CompileAndRunBook("int main(void) { int to_shiftr = 382574; to_shiftr >>= 4; return to_shiftr; }"));
}

// to_xor ^= 5;
TEST_F(CodegenTest, Chapter5_CompoundBitwiseXor)
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int to_xor = 7; to_xor ^= 5; return to_xor; }"));
}

// to_divide /= 4;
TEST_F(CodegenTest, Chapter5_CompoundDivide)
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int to_divide = 8; to_divide /= 4; return to_divide; }"));
}

// to_subtract -= 8;
TEST_F(CodegenTest, Chapter5_CompoundMinus)
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int to_subtract = 10; to_subtract -= 8; return to_subtract; }"));
}

// to_mod %= 3;
TEST_F(CodegenTest, Chapter5_CompoundMod)
{
    EXPECT_EQ("2\n", CompileAndRunBook("int main(void) { int to_mod = 5; to_mod %= 3; return to_mod; }"));
}

// to_multiply *= 3;
TEST_F(CodegenTest, Chapter5_CompoundMultiply)
{
    EXPECT_EQ("12\n", CompileAndRunBook("int main(void) { int to_multiply = 4; to_multiply *= 3; return to_multiply; }"));
}

// to_add += 4;
TEST_F(CodegenTest, Chapter5_CompoundPlus)
{
    EXPECT_EQ("4\n", CompileAndRunBook("int main(void) { int to_add = 0; to_add += 4; return to_add; }"));
}
