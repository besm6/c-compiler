...
// --- x86 byte-addressing / alignment assumptions -----------------------------

// allocation/test_alignment: checks (unsigned long)ptr % 16 == 0; a BESM-6 pointer is a word address.
TEST_F(CodegenTest, DISABLED_Chapter15_TestAlignment)
{
    EXPECT_EQ("0\n", CompileAndRun(WrapMain(R"(/* Test that we allocate enough space for arrays on the stack
