 ...
 * implemented in libc.bin; the rest are declared for future implementation (TODO).
 * float == double == long double (one word), so the single double-typed entry
 * points serve every floating type.
 *
