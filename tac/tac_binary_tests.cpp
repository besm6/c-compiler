...
TEST_F(TacBinaryTest, ReturnAllConstKinds)
{
    ...
    for (const auto &tc : cases) {
        ...
        switch (tc.kind) {
        case TAC_CONST_INT:        c->u.int_val        = -99;          break;
        case TAC_CONST_LONG:       c->u.long_val       = 100000L;      break;
        case TAC_CONST_LONG_LONG:  c->u.long_long_val  = -9000000000LL;break;
        case TAC_CONST_UINT:       c->u.uint_val       = 7u;           break;
        case TAC_CONST_ULONG:      c->u.ulong_val      = 123456ul;     break;
        case TAC_CONST_ULONG_LONG: c->u.ulong_long_val = 999999999999ull;break;
        case TAC_CONST_DOUBLE:     c->u.double_val     = 3.14;         break;
        case TAC_CONST_CHAR:       c->u.char_val       = 65;           break;
        case TAC_CONST_UCHAR:      c->u.uchar_val      = 200;          break;
        default: break;
        }
        Tac_Val *val        = tac_new_val(TAC_VAL_CONSTANT);
        val->u.constant     = c;
...
{
    Tac_UnaryOperator ops[] = {
        TAC_UNARY_COMPLEMENT, TAC_UNARY_NEGATE, TAC_UNARY_NOT
    };
...
TEST_F(TacBinaryTest, AllBinaryInstructions)
{
    Tac_BinaryOperator ops[] = {
        ...
        TAC_BINARY_DIVIDE, TAC_BINARY_REMAINDER,
        TAC_BINARY_EQUAL, TAC_BINARY_NOT_EQUAL,
        TAC_BINARY_LESS_THAN, TAC_BINARY_LESS_OR_EQUAL,
        TAC_BINARY_GREATER_THAN, TAC_BINARY_GREATER_OR_EQUAL,
        TAC_BINARY_BITWISE_AND, TAC_BINARY_BITWISE_OR, TAC_BINARY_BITWISE_XOR,
        TAC_BINARY_LEFT_SHIFT, TAC_BINARY_RIGHT_SHIFT,
    };
...
{
    Tac_TypeKind kinds[] = {
        TAC_TYPE_CHAR, TAC_TYPE_SCHAR, TAC_TYPE_UCHAR,
        TAC_TYPE_SHORT, TAC_TYPE_INT, TAC_TYPE_LONG, TAC_TYPE_LONG_LONG,
        TAC_TYPE_USHORT, TAC_TYPE_UINT, TAC_TYPE_ULONG, TAC_TYPE_ULONG_LONG,
