...
static void export_dot_val(FILE *fd, const Tac_Val *val, int parent_id, const char *edge_label);
static void export_dot_type(FILE *fd, const Tac_Type *type, int parent_id, const char *edge_label);
